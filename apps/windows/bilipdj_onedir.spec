...
hiddenimports = [
    ...
    "apps.windows.bilibili_qr_dialog", "apps.windows.style_save_transport", "apps.windows.update_client", "apps.windows.update_ui",
    "apps.windows.update_network", "apps.windows.update_page", "apps.windows.overlay_refresh_guard",
    "apps.windows.overlay_performance_guard", "apps.windows.slider_switches",
