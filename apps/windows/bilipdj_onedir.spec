...
hiddenimports = [
    ...
    "apps.windows.support_us", "apps.windows.webdav_backup_ui", "apps.windows.issue79_features", "apps.windows.redtv_control_guard", "apps.windows.unified_theme",
    ...
    "core.server", "core.update_ui", "core.youtube_protocol",
