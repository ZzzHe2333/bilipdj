...
def _install_core_runtime(panel_class: type[Any]) -> None:
    """Install the stable Tk/ttk shell and common desktop behavior."""
...
def install_desktop_runtime(panel_class: type[Any]) -> bool:
    """Install the production Windows Tk/ttk runtime exactly once."""
